				...
				<div class="row recom-item">
					...
					<div class="col-lg-9 col-md-9 col-sm-12 col-xs-12 categories-right">
						<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 p0">
							<div class="title-item">{{trans('toppage.Search results')}}</div>
						</div>
						...
						<div class="row items-list no-slider">		
							@if ( count($campaigns) > 0 )					
								...
								<div class='row page-item'><?php echo $campaigns->appends(['keyword' => $keyword])->links(); ?></div>
							@else
								{{trans('toppage.Search Result is not campaign')}}
							@endif
						</div>
					</div>
				</div>
